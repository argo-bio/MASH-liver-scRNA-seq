...
## Overview
This repository contains the R codebase for analyzing single-cell RNA sequencing (scRNA-seq) data derived from mouse models of Metabolic Dysfunction-Associated Steatohepatitis (MASH). The project investigates the role of the **CTNNB1 (β-catenin)** signaling pathway in hepatic macrophage immunometabloism reprograming and disease progression.
